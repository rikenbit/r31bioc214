...
describe 'check R version' do
  it "check R version" do
    ...
    assert system('grep "R version 3.2.2" showversion.Rout'), 'R version is not expected version. maybe r-base package is updated'
  end
end
describe 'check Bioconductor version' do
  it "check Bioconductor version" do
    ...
    assert system('grep "Bioconductor version 3.2 (BiocInstaller 1.20.0)" showBioconductorVersion.Rout'), 'Bioconductor version is not expected version. maybe Bioconductor package is updated'
  end
end
