...
describe 'check R version' do
  it "check R version" do
    system('/usr/local/R/3.1.2/bin/R CMD BATCH showversion.R')
...
describe 'check Bioconductor version' do
  it "check Bioconductor version" do
    ...
    # stable
    assert system('grep "Bioconductor version 3.0 (BiocInstaller 1.16.1)" showBioconductorVersion.Rout'), 'Bioconductor version is not expected version. maybe Bioconductor package is updated'
  end
end
