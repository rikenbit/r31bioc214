...
describe 'check R version' do
  it "check R version" do
    ...
    assert system('grep "R version 3.4.2 Patched" showversion.Rout'), 'R version is not expected version. maybe r-base package is updated'
  end
end
describe 'check Bioconductor version' do
  it "check Bioconductor version" do
    ...
    assert system('grep "Bioconductor version 3.6 (BiocInstaller 1.28.0)" showBioconductorVersion.Rout'), 'Bioconductor version is not expected version. maybe Bioconductor package is updated'
  end
end
